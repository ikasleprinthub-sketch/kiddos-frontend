...
export default function SpicesOils() {
    ...
    <section className="bg-gray-50 py-10 px-4 border-t border-gray-100">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8 pb-4 border-b border-zinc-100">
          <div>
            <h2 className="text-[#2a7a2a] font-black text-2xl tracking-tight">Spices & Oils</h2>
            <p className="text-xs text-zinc-500 mt-1">Aromatic home-style spice mixes and wood-pressed pure oils</p>
          </div>
        </div>
